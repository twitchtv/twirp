...
class SvcClient(object):
    def __init__(self, server_address):
        ...
        self.__service_name = "twirp.internal.twirptest.importer_local.Svc"
    ...
    def send(self, msg):
        serialize = _sym_db.GetSymbol("twirp.internal.twirptest.importer_local.Msg").SerializeToString
        deserialize = _sym_db.GetSymbol("twirp.internal.twirptest.importer_local.Msg").FromString
