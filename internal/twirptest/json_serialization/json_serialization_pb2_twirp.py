...
class JSONSerializationClient(object):
    def __init__(self, server_address):
        """Creates a new client for the JSONSerialization service.
        ...
        self.__service_name = "JSONSerialization"
