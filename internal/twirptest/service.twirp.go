...
type Streamer interface {
	...
	Upload(ctx context.Context, in <-chan ReqOrError) (*Resp, error)

	Download(ctx context.Context, in *Req) (<-chan RespOrError, error)

	Communicate(ctx context.Context, in <-chan ReqOrError) (<-chan RespOrError, error)
}
...
func (c *streamerProtobufClient) Upload(ctx context.Context, in <-chan ReqOrError) (*Resp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.internal.twirptest")
	ctx = ctxsetters.WithServiceName(ctx, "Streamer")
...
func (c *streamerProtobufClient) Communicate(ctx context.Context, in <-chan ReqOrError) (<-chan RespOrError, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.internal.twirptest")
	ctx = ctxsetters.WithServiceName(ctx, "Streamer")
...
func (c *streamerJSONClient) Upload(ctx context.Context, in <-chan ReqOrError) (*Resp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.internal.twirptest")
	ctx = ctxsetters.WithServiceName(ctx, "Streamer")
	ctx = ctxsetters.WithMethodName(ctx, "Upload")
	return nil, nil
...
func (c *streamerJSONClient) Communicate(ctx context.Context, in <-chan ReqOrError) (<-chan RespOrError, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.internal.twirptest")
	ctx = ctxsetters.WithServiceName(ctx, "Streamer")
	ctx = ctxsetters.WithMethodName(ctx, "Communicate")
	return nil, nil
...
func (s *streamerServer) serveDownloadProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	writeTrailer := func(err error) {
		defer func() {
			n, writeErr := resp.Write(trailer.Bytes())
			log.Printf("writing %d bytes of trailer", n)
			if writeErr != nil {
	...
	for {
		...
		n, err := resp.Write(messages.Bytes())
		log.Printf("writing %d bytes of msg", n)
		if err != nil {
