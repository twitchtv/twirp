...
type Haberdasher interface {
	MakeHatV1(context.Context, *SizeV1) (*HatV1, error)
}
...
func (c *haberdasherProtobufClient) MakeHatV1(ctx context.Context, in *SizeV1) (*HatV1, error) {
...
func (c *haberdasherJSONClient) MakeHatV1(ctx context.Context, in *SizeV1) (*HatV1, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.internal.twirptest.snake_case_names")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
	ctx = ctxsetters.WithMethodName(ctx, "MakeHatV1")
	out := new(HatV1)
...
func (s *haberdasherServer) serveMakeHatV1JSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *HatV1 and nil error while calling MakeHatV1. nil responses are not supported"))
		return
	}
