...
/*
Package use_empty is a generated twirp stub package.
...
type Svc interface {
	Send(context.Context, *Msg) (*google_protobuf.Empty, error)
}
...
func (c *svcProtobufClient) Send(ctx context.Context, in *Msg) (*google_protobuf.Empty, error) {
...
func (c *svcJSONClient) Send(ctx context.Context, in *Msg) (*google_protobuf.Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.internal.twirptest.use_empty")
	ctx = ctxsetters.WithServiceName(ctx, "Svc")
	ctx = ctxsetters.WithMethodName(ctx, "Send")
	out := new(google_protobuf.Empty)
