...
func (t *twirp) generateUtils() {
	...
	t.P("  Meta map[string]interface{} `json:\"meta,omitempty\"`")
	t.P(`}`)
	t.P()
	...
	t.P(`func (e *internalWithCause) Meta(key string) interface{}     { return "" }`)
	t.P(`func (e *internalWithCause) MetaMap() map[string]interface{} { return nil }`)
	t.P(`func (e *internalWithCause) WithMeta(key string, val interface{}) `, t.pkgs["twirp"], `.Error { return e }`)
	t.P()
