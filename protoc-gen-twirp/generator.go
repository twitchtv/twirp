...
func (t *twirp) generateUtils() {
	...
	t.P(`  buf, err := `, t.pkgs["protojson"], `.Marshal(in)`)
	t.P(`  if err != nil {`)
	t.P(`    return wrapInternal(err, "failed to marshal json request")`)
	t.P(`  }`)
	t.P(`  reqBody := `, t.pkgs["bytes"], `.NewBuffer(buf)`)
	t.P(`  if err = ctx.Err(); err != nil {`)
	t.P(`    return wrapInternal(err, "aborted because context was done")`)
	t.P(`  }`)
	t.P()
	...
	t.P(`  }`)
	t.P()
	t.P(`  buf, err = `, t.pkgs["ioutil"], `.ReadAll(resp.Body)`)
	t.P(`  if err != nil {`)
	t.P(`    return wrapInternal(err, "failed to unmarshal response")`)
	t.P(`  }`)
	t.P(`  if err = `, t.pkgs["protojson"], `.Unmarshal(buf, out); err != nil {`)
...
func (t *twirp) generateServerJSONMethod(service *descriptor.ServiceDescriptorProto, method *descriptor.MethodDescriptorProto) {
	...
	t.P(`    return`)
	t.P(`  }`)
	t.P(`  if err = `, t.pkgs["protojson"], `.Unmarshal(buf, reqContent); err != nil {`)
	...
	t.P()
	t.P(`  respBytes, err := `, t.pkgs["protojson"], `.Marshal(respContent)`)
	t.P(`  if err != nil {`)
