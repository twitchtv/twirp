...
func (c *svcProtobufClient) Send(ctx context.Context, in *Msg) (*Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.twirptest.gogo_compat")
...
const SvcPathPrefix = "/twirp/twirp.twirptest.gogo_compat.Svc/"
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirp.twirptest.gogo_compat.Svc/Send":
...
var twirpFileDescriptor0 = []byte{
	...
	0x16, 0xa7, 0x4b, 0x11, 0x54, 0xe1, 0xc4, 0x1b, 0xc5, 0x8d, 0x24, 0x94, 0xc4, 0x06, 0x76, 0x8c,
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x0e, 0x8c, 0x93, 0x9c, 0x9d, 0x00, 0x00, 0x00,
}
