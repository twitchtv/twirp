...
func (c *svcProtobufClient) Send(ctx context.Context, in *google_protobuf1.StringValue) (*google_protobuf.Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.twirptest.use_empty")
...
const SvcPathPrefix = "/twirp/twirp.twirptest.use_empty.Svc/"
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirp.twirptest.use_empty.Svc/Send":
