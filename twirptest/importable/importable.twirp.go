...
func (c *svcProtobufClient) Send(ctx context.Context, in *Msg) (*Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.twirptest.importable")
...
const SvcPathPrefix = "/twirp/twirp.twirptest.importable.Svc/"
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirp.twirptest.importable.Svc/Send":
