...
func (c *svc2ProtobufClient) Send(ctx context.Context, in *Msg2) (*Msg2, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.twirptest.multiple")
...
const Svc2PathPrefix = "/twirp/twirp.twirptest.multiple.Svc2/"
...
func (s *svc2Server) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirp.twirptest.multiple.Svc2/Send":
		s.serveSend(ctx, resp, req)
		return
	case "/twirp/twirp.twirptest.multiple.Svc2/SamePackageProtoImport":
