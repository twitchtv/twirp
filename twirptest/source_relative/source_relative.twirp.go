...
func (c *svcProtobufClient) Method(ctx context.Context, in *Msg) (*Msg, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirp.twirptest.source_relative")
...
const SvcPathPrefix = "/twirp/twirp.twirptest.source_relative.Svc/"
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirp.twirptest.source_relative.Svc/Method":
